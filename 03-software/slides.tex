...
%\vspace*{\fill}
%\begin{verbatim}
%$ aws ec2 run-instances --image-id ami-0187f76b
%\end{verbatim}
%\vspace*{\fill}
...
\vspace*{\fill}
\begin{center}
	\includegraphics[scale=0.55,angle=-90]{pics/post.eps} \\
\end{center}
\vspace*{\fill}
...
\vspace*{\fill}
\begin{center}
	\includegraphics[scale=1.0,angle=-90]{pics/BIOS.eps} \\
\end{center}
\vspace*{\fill}
...
\begin{center}
	...
	\includegraphics[scale=0.5,angle=-90]{pics/car-firmware.eps}
\end{center}
...
\begin{center}
	...
	\includegraphics[scale=0.8,angle=-90]{pics/usb-icon.eps}
\end{center}
...
\vfill
\begin{center}
	\includegraphics[scale=0.7,angle=-90]{pics/unikernel.eps}
\end{center}
\vfill
